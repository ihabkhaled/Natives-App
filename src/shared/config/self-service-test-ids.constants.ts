...
export const SELF_SERVICE_TEST_IDS = {
  ...
  practiceSessionAgendaGroupsCta: 'practice-session-agenda-groups-cta',
  ...
  myAttendanceCheckInState: 'my-attendance-check-in-state',
  myAttendanceHistorySection: 'my-attendance-history-section',
  myAttendanceHistoryRow: 'my-attendance-history-row',
  myAttendanceHistoryEmpty: 'my-attendance-history-empty',
  myAttendanceHistoryLoadMore: 'my-attendance-history-load-more',
