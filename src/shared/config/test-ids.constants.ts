...
import { DRILLS_TEST_IDS } from './drills-test-ids.constants';
...
export const TEST_IDS = {
  ...
  ...PRACTICE_AGENDA_GROUPS_TEST_IDS,
  ...
  guardAccountPending: 'guard-account-pending',
  ...
  signupPendingSteps: 'signup-pending-steps',
  signupSignInLink: 'signup-sign-in-link',
