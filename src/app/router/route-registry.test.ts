...
describe('getAppRouteDefinitions', () => {
  it('aggregates every module route table', () => {
    expect(paths()).toEqual([
      ...
      APP_PATHS.gallery,
      APP_PATHS.location,
      APP_PATHS.publicAchievements,
      APP_PATHS.home,
      APP_PATHS.contact,
      APP_PATHS.team,
      APP_PATHS.publicCompetitions,
      APP_PATHS.publicCompetitionDetail,
      APP_PATHS.news,
