...
export function SettingsView(props: SettingsViewProps): React.JSX.Element {
  return (
    <PageShell title={props.title} testId={TEST_IDS.settingsPage}>
      <main className="app-settings-layout">
        <IonList inset>
          <IonListHeader>
          ...
          <IonItem>
            ...
            <IonSegment
              ...
              onIonChange={(event) => {
                props.onThemeChange(event.detail.value as ThemeMode);
              }}
            >
          ...
          <IonItem>
            ...
            <IonSegment
              ...
              onIonChange={(event) => {
                props.onLocaleChange(event.detail.value as AppLocale);
              }}
            >
          ...
          <IonItem>
            <IonLabel>{props.connectivityLabel}</IonLabel>
            <IonBadge
              className="app-settings-status-badge"
