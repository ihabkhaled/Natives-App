...
describe('buildTimelineRows', () => {
  ...
  it('bounds the rendered timeline', () => {
    ...
    expect(buildTimelineRows(t, events)).toHaveLength(MATCH_TIMELINE_LIMIT);
  });
});
